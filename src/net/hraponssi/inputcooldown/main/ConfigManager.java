...
public class ConfigManager {
	...
	public void setup() {
		...
		if (!datafile.exists()) {
			try {
				...
				Bukkit.getServer().getConsoleSender().sendMessage(ChatColor.GREEN + "The " + dataname + " file has been created");
			} catch (IOException e) {
		...
		if (!langfile.exists()) {
			try {
				...
				Bukkit.getServer().getConsoleSender().sendMessage(ChatColor.GREEN + "The " + langname + " file has been created");
			} catch (IOException e) {
				Bukkit.getServer().getConsoleSender()
	...
	public void saveData() {
		try {
			...
			Bukkit.getServer().getConsoleSender().sendMessage(ChatColor.AQUA + "The " + dataname + " file has been saved");
		} catch (IOException e) {
			Bukkit.getServer().getConsoleSender().sendMessage(ChatColor.RED + "Could not save the " + dataname + " file");
		}
	}
